...
const institutionalprojectslist = [
  {
    ...
    projectDes: "GF+02 Floor",
    projectYear: "2024-Current",
    architect: "Kakani Associate",
    consultant: "Japan Shah Consulting Engineers",
    scope:
      "Construction RCC frame work, Exposed Masonary, Plaster, All finishing work, Structural Steel, plumbing work & Infrastructure devlopment work.",
  },
  {
    ...
    scope:
      "Construction Civil work with all Finishing work &  Allied Structure Works.",
  },
];
